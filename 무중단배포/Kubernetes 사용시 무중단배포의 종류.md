...
오늘 정리하는 내용은 개념이다. 갈길이 바쁘다. Argo CD 로 어떻게 Rollouts 를 사용해서 배포를 하는지, Github Action 과 연동하는지 정리해야 하는데, 오늘 3가지 배포 방식들에 대해 예제를 떠올리고 일일이 잘 읽히도록 설명 글을 쓰면서 뭔가 신경이 쇠약해진 느낌? 이 잠깐 왔었다.. 오마이갓...<br>

<br>

다시 한번 적지만, 오늘 쓰는 글은 개념이다. 이해만 하기 위한 글이다. ArgoCD 의 Rollout 을 사용하는 글은 이번주 토요일,일요일, 월요일 예제가 얼추 만들어질 것 같다.<br>
